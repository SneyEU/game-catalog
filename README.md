...
Par convention, le fichier doit s'appeler docker-compose.yml ou compose.yml. Il utilise le YAML. Pour ajouter des dépendances, il faut utiliser le fichier Dockerfile.
Architecture MVC
...
Le repository ne sait pas pourquoi on demande les données, il sait seulement comment les récupérer.
...
Le contrôleur ne fait pas de SQL et ne décide pas des règles métier.
